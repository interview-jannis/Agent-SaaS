// products_master_v18.xlsx → products_master_v19.xlsx
// Changes:
//   - Rename column why_recommendation → highlights
//   - Remove old TRABIC/VERITAS/Merit Limousine rows (replaced below)
//   - Fix OK KOREA COMPANY concierge prices → 0
//   - Fix Sofitel ROYAL packages → 0
//   - Add K-Medical: EYEREUM Eye Clinic, Podo Women's Clinic, Live Dental Hospital
...
const V19_PATH = path.join(__dirname, '../products_master_v19.xlsx');
...
async function write() {
  ...
  console.log(`Total rows: ${allRows.length} (was 317)`);
