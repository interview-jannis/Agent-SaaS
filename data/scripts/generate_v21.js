// products_master_v18.xlsx → products_master_v21.xlsx
// Changes from v18 → v21 (includes all v20 changes plus):
...
// v20 → v21:
//   - Fix Ruby Clinic: clear erroneous botox-brand variant labels (Xeomin/Allergan/Domestic) from 3 package rows
//   - Fix SELENA Clinic Hongdae: clear erroneous botox-brand variant labels from all 3 rows
//     (incl. "Royal Refresh Day" which explicitly states "no injection" — Xeomin variant was factually wrong)
...
const V19_PATH = path.join(__dirname, '../products_master_v21.xlsx');
